...
enum class StatusCode(val code: Int, val message: String) {
    ...
    REQUIRED_TIMEOUT(408, "Session Timeout"),
    CONFLICT(409, "Conflict"),
    GONE(410, "Gone"),
    LENGTH_REQUIRED(411, "Length Required"),
    PRECONDITION_FAILED(412, "Precondition Failed"),
    REQUEST_ENTITY_TOO_LARGE(413, "Session Entity Too Large"),
    REQUEST_URI_TOO_LONG(414, "Session-URI Too Long"),
    ...
    REQUEST_HEADER_FIELD_TOO_LARGE(431, "Session Header Fields Too Large"),
    ...
    CLIENT_CLOSED_REQUEST(490, "Client Closed Session"),
